...
<html>
    ...
    protected function _tag_close_TABLE($param)
    {
        ...
        if ($this->_subPart) {
            ...
            if (self::$_tables[$param['num']]['height'] != null && count(self::$_tables[$param['num']]['height'])>1) {
                $y = $this->_margeTop+self::$_tables[$param['num']]['height'][count(self::$_tables[$param['num']]['height'])-1];
            } elseif (self::$_tables[$param['num']]['height'] != null && count(self::$_tables[$param['num']]['height']) == 1) {
    ...
    protected function _tag_open_TR($param, $other = 'tr')
    {
        ...
        if (!$this->_subPart) {
            ...
            // Y after the row
            $ty=null;
            $nbTrCurrs = self::$_tables[$param['num']]['cases'][self::$_tables[$param['num']]['tr_curr']-1] == null ? 0 : count(self::$_tables[$param['num']]['cases'][self::$_tables[$param['num']]['tr_curr']-1]);
