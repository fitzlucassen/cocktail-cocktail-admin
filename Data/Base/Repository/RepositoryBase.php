<?php 
	...
	class RepositoryBase  {
		...
		public static function getAll($Connection) {
			...
			$query = $qb->select()->from(array(""))->getQuery();
			try {
		...
		public function getById($id) {
			$query = $this->_queryBuilder->select()->from(array(""))
		...
		public function delete($id) {
			$query = $this->_queryBuilder->delete("")
		...
		public function add($properties) {
			$query = $this->_queryBuilder->insert("", array())->getQuery();
			try {
				return $this->_pdo->Query($query);
			}
			catch(PDOException $e){
		...
		public function update($id, $properties) {
			$query = $this->_queryBuilder->update("", array())->where(array(array("link" => "", "left" => "id", "operator" => "=", "right" => $id )))->getQuery();
			try {
				return $this->_pdo->Query($query);
			}
			catch(PDOException $e){
